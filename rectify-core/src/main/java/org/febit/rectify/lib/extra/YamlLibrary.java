...
public class YamlLibrary implements Library {
     ...
     * Namespace: YAML.
     */
    @BindingAlias(value = {"YAML"}, keepDeclaredName = false)
    public static final YamlNamespace YAML = new YamlNamespace();

    public static class YamlNamespace implements Namespace {
