...
public class StructSpecs {
    ...
    public static StructSpec<Object[]> asArray() {
        return ObjectArrayStructSpec.INSTANCE;
    }

    public static StructSpec<List<Object>> asList() {
        return ListStructSpec.INSTANCE;
    }

    public static StructSpec<Map<String, Object>> asMap() {
        return MapStructSpec.INSTANCE;
    }

    private static class ListStructSpec implements StructSpec<List<Object>>, Serializable {

        private static final ListStructSpec INSTANCE = new ListStructSpec();

        @Override
        public List<Object> create(Schema schema) {
    ...
    private static class MapStructSpec implements StructSpec<Map<String, Object>>, Serializable {

        private static final MapStructSpec INSTANCE = new MapStructSpec();

        @Override
        public Map<String, Object> create(Schema schema) {
    ...
    private static class ObjectArrayStructSpec implements StructSpec<Object[]>, Serializable {
